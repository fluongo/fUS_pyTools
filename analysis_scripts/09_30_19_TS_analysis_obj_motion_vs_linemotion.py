...
# Load the fUS data
##################################################################
data_dir = '/data/fUS_project/data/data_Sep30/'
fns = sorted(glob.glob(data_dir + '/RT*.mat')); # NOW DO THE LAST 15
timelines = len(fns)*[data_dir + '/timeline_09-30-2019_12-52.mat']
n_fus = range(len(fns))
...
for ii in range(15):
    ...
    exportDir = outDir + '/extras_obj_mot_v_line_mot/'
...
np.save(exportDir + 'data_processed_obj_motion.npy', all_exp_dicts)
